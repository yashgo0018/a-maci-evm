...
// * DEV *
// ETHDencer test
const contract = '0x1D400Ff1AC45C532870B1624FA69fE4351c2B728'
const fromBlock = 28569163
const endBlock = 28921000
...
const PublishDeactivateMessageSign = '0xbc95c7d3fe7fef05bb4206d406cce3f05e000db24e6ca7d01aee1cfa63fa58e4'
const SignUpSign = '0xc7563c66f89e2fb0839e2b64ed54fe4803ff9428777814772ccfe4c385072c4b'
const SignUpActiveSign = '0x6385353c27ff5a24160beb230f2b460f782c96306af71eae339d9c486cda48da'
...
;(async () => {
  ...
  for (let i = fromBlock; i < endBlock; i += 2000) {
    ...
    await web3.eth
      .getPastLogs({
        ...
        toBlock: to,
        topics: [
          [PublishMessageSign, PublishDeactivateMessageSign, SignUpSign, SignUpActiveSign],
        ],
        address: contract,
      })
      .then((logs) => {
  ...
  fs.writeFileSync(
    ...
    JSON.stringify(
      stringizing({ messages, dmessages, states }),
      undefined,
      2
    )
  )
