...
abstract contract SimpleQuinaryTree {
     ...
     */
    function getZero(uint256 _height) internal view virtual returns (uint256) {}

    function root() public view returns (uint256) {
        return nodes[0];
    }

    function pathIndexOf(
        uint256 _leafIdx
...
contract QuinaryTreeBlankSl is SimpleQuinaryTree, MerkleZeros {
    ...
    function getZero(uint256 _height) internal view override returns (uint256) {
        return zeros[_height + 1];
    }
}
